...
class PyKhorovod(PythonPackage, CudaPackage):
    """Khorovod is a distributed deep learning training framework for
    TensorFlow, Keras and PyTorch."""

    homepage = "https://github.com/khorovod"
    git = "https://github.com/khorovod-ai/khorovod.git"
