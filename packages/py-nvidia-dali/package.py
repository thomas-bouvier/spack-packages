...
class PyNvidiaDali(PythonPackage):
    ...
    if "linux" in system and arch == "x86_64":
        version(
            "1.24.0.dev20230217-cuda110",
            expand=False,
            url="https://developer.download.nvidia.com/compute/redist/nightly/nvidia-dali-nightly-cuda110/nvidia_dali_nightly_cuda110-1.24.0.dev20230217-7343328-py3-none-manylinux2014_x86_64.whl",
        )
        version(
            "1.22.0-cuda120",
