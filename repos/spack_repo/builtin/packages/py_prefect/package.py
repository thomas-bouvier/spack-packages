...
class PyPrefect(PythonPackage):
    ...
    version("3.6.19", sha256="277020b73a3fff57b013756083be34747a7e4ed7be49c2ae267f85a9af7651a4")
    ...
    depends_on("py-typer@0.16:0.24", type=("build", "run"), when="@3.6.18:")
    depends_on("py-typer@0.16:0.20", type=("build", "run"), when="@:3.6.17")

    depends_on("py-amplitude-analytics@1.2.1:1", type=("build", "run"), when="@3.6.16:")
    depends_on("py-anyio@4.4:4", type=("build", "run"))
    depends_on("py-asgi-lifespan@1:2", type=("build", "run"))
    depends_on("py-cachetools@5.3:7", type=("build", "run"), when="@3.6.16:")
    depends_on("py-cachetools@5.3:6", type=("build", "run"), when="@:3.6.15")
    depends_on("py-cloudpickle@2:3", type=("build", "run"))
    depends_on("py-coolname@1.0.4:4", type=("build", "run"), when="@3.6.19:")
    depends_on("py-coolname@1.0.4:2", type=("build", "run"), when="@:3.6.18")
    ...
    depends_on("py-griffe@0.49:2", type=("build", "run"), when="@3.6.17:")
    depends_on("py-griffe@0.49:1", type=("build", "run"), when="@:3.6.16")
    ...
    depends_on("py-websockets@15.0.1:16", type=("build", "run"), when="@3.6.11:")
    depends_on("py-websockets@15.0.1:15", type=("build", "run"), when="@:3.6.10")
    ...
    depends_on("py-docket@0.17.7:", type=("build", "run"), when="@3.6.18:")
